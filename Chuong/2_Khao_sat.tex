...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth,height=13.1cm]{Hinhve/uc tổng quan.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth,height=10.49cm]{Hinhve/uc tạo phiên đấu giá.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth,height=9.35cm]{Hinhve/uc tìm kiếm thông tin.png}
...
%\begin{table}[H]
    ...
    \hline
        ...
        \bfseries Luồng sự kiện thay thế & \multicolumn{3}{c|}{
        \begin{tabular}{| p{.05\textwidth} | p{.15\textwidth} | p{.40\textwidth} |} 
            \hline
                \bfseries STT & \bfseries Thực hiện &  \bfseries Hành động \\\hline
    ...
    \hline
        ...
        \begin{tabular}{| p{.05\textwidth} | p{.15\textwidth} | p{.40\textwidth} |} 
            \hline
                ...
                5 & Hệ thống & Hiển thị hộp thoại nhập lý do từ chối. \\\hline
