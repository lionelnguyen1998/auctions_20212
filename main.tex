...
%\begin{table}[H]
    %\centering
    \begin{longtable}{| p{.15\textwidth} | p{.25\textwidth} | p{.50\textwidth} |} 
    \hline
...
%\begin{table}[H]
    %\centering
    \begin{longtable}{| p{.20\textwidth} | p{.15\textwidth} | p{.15\textwidth} | p{.30\textwidth} |} 
    \hline
...
%\begin{table}[H]
    %\centering
    \begin{longtable}{| p{.27\textwidth} | p{.15\textwidth} | p{.10\textwidth} | p{.30\textwidth} |} 
    \hline
        \multicolumn{4}{|c|}{Lớp AuctionController}\\\hline
        \bfseries Tên phương thức & \bfseries Đầu vào & \bfseries Đầu ra & \bfseries Ý nghĩa  \\\hline
...
%\begin{table}[H]
    %\centering
    \begin{longtable}{| p{.05\textwidth} | p{.30\textwidth} | p{.10\textwidth} | p{.40\textwidth} |} 
    \hline
...
%\begin{table}[H]
    %\centering
    \begin{longtable}{| p{.30\textwidth} | p{.25\textwidth} | p{.35\textwidth} |} 
    \hline
...
%\begin{table}[H]
    %\centering
    \begin{longtable}{| p{.45\textwidth}|p{.30\textwidth}|p{.15\textwidth}|} 
    \hline
